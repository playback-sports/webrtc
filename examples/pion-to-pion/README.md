...
go install github.com/playback-sports/webrtc/v3/examples/pion-to-pion/answer
answer
```
Next, run `offer`:
```sh
go install github.com/playback-sports/webrtc/v3/examples/pion-to-pion/offer
offer
```
